...
test('live settings reach the status row and completion produces one service notification',async()=>{
  ...
  const listeners=new Map(),data=new Map(),session=new Map(),notifications=[];
