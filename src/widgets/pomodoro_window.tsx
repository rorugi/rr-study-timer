...
export function PomodoroWindow() {
  ...
  return <main className="pomodoro-window">
    <header><strong>RR Pomodoro</strong><button type="button" aria-label="Close Pomodoro window" onClick={() => void close()}>×</button></header>
