...
export function DailyStatistics({ section = 'all' }: { section?: 'all' | 'week' | 'today' } = {}) {
  ...
  return (
    <div className="study-overview-stats">
      ...
      {section !== 'today' && <section className="weekly-time" aria-label="Lernzeit diese Woche">
      ...
      {section !== 'week' && <section className="daily-stats" aria-label="Lernen heute">
